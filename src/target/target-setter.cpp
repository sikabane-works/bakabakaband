...
static void describe_projectablity(player_type *creature_ptr, ts_type *ts_ptr)
{
    ...
    char cheatinfo[50];
    sprintf(cheatinfo, " X:%d Y:%d LOS:%d LOP:%d ID:%d SID:%d", ts_ptr->x, ts_ptr->y, los(creature_ptr, creature_ptr->y, creature_ptr->x, ts_ptr->y, ts_ptr->x),
        projectable(creature_ptr, creature_ptr->y, creature_ptr->x, ts_ptr->y, ts_ptr->x), ts_ptr->g_ptr->feat, ts_ptr->g_ptr->mimic);
...
static void describe_grid_wizard(player_type *creature_ptr, ts_type *ts_ptr)
{
    ...
    char cheatinfo[100];
    sprintf(cheatinfo, " X:%d Y:%d LOS:%d LOP:%d SPECIAL:%d ID:%d SID:%d", ts_ptr->x, ts_ptr->y, los(creature_ptr, creature_ptr->y, creature_ptr->x, ts_ptr->y, ts_ptr->x),
        projectable(creature_ptr, creature_ptr->y, creature_ptr->x, ts_ptr->y, ts_ptr->x), ts_ptr->g_ptr->special, ts_ptr->g_ptr->feat, ts_ptr->g_ptr->mimic);
    strcat(ts_ptr->info, cheatinfo);
}
