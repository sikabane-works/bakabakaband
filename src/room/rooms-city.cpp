...
{
    const auto y1 = pos_ug.y + this->north_west.y - 5;
    const auto x1 = pos_ug.x + this->north_west.x - 5;
    const auto y2 = pos_ug.y + this->south_east.y + 5;
    const auto x2 = pos_ug.x + this->south_east.x + 5;
    return { { y1, x1 }, { y2, x2 } };
}
