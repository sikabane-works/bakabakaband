...
enum race_flags3 {
    ...
    RF3_HURT_LITE = 0x00001000, /*!< モンスター特性: 通常の光(AttributeType::WEAK_LITE)でダメージを受ける / Hurt by lite */
    RF3_HURT_ROCK = 0x00002000, /*!< モンスター特性: 岩石溶解(AttributeType::KILL_WALL)でダメージを受ける / Hurt by rock remover */
