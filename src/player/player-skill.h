...
#define SKILL_WEAPON_DAGGER 4
#define SKILL_WEAPON_SHORT_SWORD 5
#define SKILL_WEAPON_LONG_SWORD 6
#define SKILL_WEAPON_GREAT_SWORD 7
#define SKILL_WEAPON_MACE 8
#define SKILL_WEAPON_SPEAR 9
#define SKILL_TEMPMAX 10
